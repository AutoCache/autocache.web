...
class MailsControllerTest < ActionController::TestCase
  ...
  test "should create mail" do
    assert_difference('Mail.count') do
      post :create, mail: { content: @mail.content, from: @mail.from, subject: @mail.subject, to: @mail.to, user_id: @mail.user_id }
    end
  ...
  test "should update mail" do
    put :update, id: @mail, mail: { content: @mail.content, from: @mail.from, subject: @mail.subject, to: @mail.to, user_id: @mail.user_id }
    assert_redirected_to mail_path(assigns(:mail))
  end
